...
constexpr auto qt_meta_stringdata_CLASSMessageHandlerENDCLASS = QtMocHelpers::stringData(
    "MessageHandler",
    "messageReceived",
    "",
    "Message",
...
void MessageHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MessageHandler::*)(const Message & );
...
// SIGNAL 0
void MessageHandler::messageReceived(const Message & _t1)
{
